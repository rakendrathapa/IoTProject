 ...
 ********************************************************************/
unsigned char __section("_SRAM_ALLOC_HEAP") _uDynamicHeap[MAX_HEAP_SIZE];
/*********************************************************************
 * Private function declarations
 ********************************************************************/
NEAR static unsigned char _SRAMmerge(SALLOC * NEAR pSegA);
...
unsigned char * SRAMalloc(unsigned char nBytes)
{
	...
	while (1)
	{
        ...
        return (0); // Non reachable statement; Return NULL
}
